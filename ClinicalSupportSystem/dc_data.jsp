...
<html>
<head>
    <title>Doctors Near you | Beyond Health</title>
...
<body  style="font-family: 'Aclonica', sans-serif; background:#d5f4e6;" ><!--style="background: linear-gradient(to bottom right,#84a9ac9d,#dcedc1d3);"-->
    ...
    <div class="container-fluid" style="border-top:1px solid blue; background:url(img/result_bg.png); height:500px;" >
    ...
    <div class="alert alert-success" role="alert" style="text-align:center;">
        DOCTORS NEAR FOR YOU. YOUR SEARCH RESULT IS HEERE.
    </div>
    
    
    <%
        String d_l=request.getParameter("d_loc");
        String d_s=request.getParameter("d_sp");
        try{
            Connection c=null;
            PreparedStatement p=null;
            ResultSet r=null;
            String sql="select * from doc_info where DISTRICT=? and SPECIALIZATION=? ";
            DriverManager.registerDriver(new com.mysql.jdbc.Driver());
            ...
            while(r.next())
            {
              if(r.getString("STATUS").equals("Verified"))
              {
                %>
                    <div class="container card-shadow" style="width:70%;margin-top:20px;">
                        <div class="row">
                          <div class="col-" style="box-shadow:2px 2px 5px;">
                            <img class="img-thamble rounded" style="height:310px;width:300px;" src="img/thamble-1.jpg"/>
                          </div>
                          <div class="col">
                          <div class="card" >
                            <div class="card-header bg-info text-light" >
                                <h5><%out.print(r.getString("NAME")+" ("+r.getString("EB")+")");%></h5>
                            </div>
                            <div class="card-body">
                              <table class="table table-borderless table-sm" style=" color:#004d4d;">
                                  <tr>
                                    <td style="width:5%;">
                                  ...
                                  <tr>
                                    <td style="width:5%;">
                                      <span class="text-info">
                                          <svg class="bi bi-cursor" width="1.2em" height="1.2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M14.082 2.182a.5.5 0 01.103.557L8.528 15.467a.5.5 0 01-.917-.007L5.57 10.694.803 8.652a.5.5 0 01-.006-.916l12.728-5.657a.5.5 0 01.556.103zM2.25 8.184l3.897 1.67a.5.5 0 01.262.263l1.67 3.897L12.743 3.52 2.25 8.184z" clip-rule="evenodd"/>
                                          </svg>
                                      </span>
                                    </td>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                      <%out.print(r.getString("APP_DAY")+" (Every Month)");%>
                                    </td>
                                  </tr>
                                   <tr>
                                    <td style="width:5%;">
                                    ...
                                    <td>
                                      <%out.print(r.getString("APP_TIME"));%>
                                    </td>
                                  </tr>
                              </table>
                            </div>
                            <div class="card-footer">
                              <form action="appointment_details.jsp" method="POST">
                                <input type="text" value="<%=r.getString("NAME")%>" name="doc_name" style="display:none;"/>
                                <input type="text" value="<%=r.getString("EMAIL")%>" name="doc_email" style="display:none;"/>
                                <input type="text" value="<%=r.getString("SPECIALIZATION")%>" name="doc_sp" style="display:none;"/>
                                <input type="text" value="<%=r.getString("MOBILE")%>" name="doc_mbel" style="display:none;"/>
                                <input type="text" value="<%=r.getString("APP_DAY")%>" name="aday" style="display:none;"/>
                                <input type="text" value="<%=r.getString("APP_TIME")%>" name="atime" style="display:none;"/>
                                <input type="text" value="<%=r.getString("ADDRESS")+r.getString("DISTRICT")+r.getString("STATE")%>" name="doc_add" style="display:none"/>
                                <button type="submit" class="btn btn-info ">Book Appoinment</button>
                              </form>
                            </div>
                          </div>
                          </div>
    ...
    <!-- footer start -->
    <footer class="footer bg-primary" style="margin-top:20px;" >
